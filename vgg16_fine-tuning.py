# -*- coding: utf-8 -*-
"""
Created on Mon Jan  7 21:10:25 2019
...
conv_base = VGG16(weights='imagenet',include_top=False,input_shape=(112,92,3))
...
history = model.fit(train_x,train_y,epochs=30,batch_size=50,validation_split=0.1)
